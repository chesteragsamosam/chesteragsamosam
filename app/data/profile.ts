export const profile = {
  ...
  height: '152 centimeters (5\'1")',
  weight: '52 kilograms (114.64 pounds)',
  eyeColor: 'Black',
  hairColor: 'Black',
  skinColor: 'Brown',
  ethnicity: 'Filipino',
  snapshot: [
    ...
    { label: 'Focus', value: 'Vue.js Â· TypeScript' },
    { label: 'Experience', value: '5 yrs Â· since 2020' },
  ],
  headline:
    'Frontend developer with 5 years of Vue.js and TypeScript experience shipping production web apps â€” including a major Philippine digital wallet â€” plus Laravel full-stack work and a practical use of AI to deliver cleaner, faster results.',
  photo: {
    src: 'portrait.jpg',
  ...
  coverLetter: {
    ...
    paragraphs: [
      'I am writing to introduce myself as a frontend developer with five years of experience building production web applications. I currently work at Ascendion, where I contribute to a widely used digital wallet in the Philippines â€” shipping features, reusable components, and interface improvements that have to hold up under real user volume and enterprise quality standards.',
  ...
  about: [
    ...
    'My core stack is Vue.js 2/3, Svelte, TypeScript, JavaScript, HTML, CSS, Bootstrap, and Tailwind CSS, with additional full-stack work in Laravel. I treat AI as a force multiplier on skills I already own â€” not a substitute for them.',
  ],
  contact: {
  ...
  personal: {
    chess:
      'I love playing chess â€” strategy, patience, and thinking a few moves ahead. It is a genuine hobby, not a professional claim: I do not list ratings, titles, or tournament results unless asked and I would not invent them.',
  },
  chat: {
    intro:
      "Hi â€” I'm Chester's digital twin. I'm a frontend developer with five years of Vue.js and TypeScript, including production work on a major Philippine digital wallet, plus Laravel full-stack experience and a practical use of AI to ship cleaner, faster work. Off the board I love chess. Ask about my career, stack, or how I think through a problem.",
    starters: [
      ...
      { label: 'Chess', prompt: 'You mentioned chess â€” how does that fit into who you are?' },
    ],
  },
  languages: [
  ...
  companies: [
    {
      id: 'ascendion',
      company: 'Ascendion',
      tenure: '2021 â€” Present',
      span: '5 years',
      roles: [
        {
          title: 'Frontend Developer',
          dates: 'November 2021 â€” Present',
          points: [
            'Feature work, support, and web-component development for a highly popular e-wallet in the Philippines.',
            'Delivered production UI under enterprise quality bars â€” maintainable, performant, and built for continued evolution of the platform.',
          ],
        },
        {
