...
- **No Em Dashes:** Never use the em dash character (—) or en dash (–) anywhere in the output.
- **No Emulated Dashes:** Do not use double or triple hyphens (-- or ---) as a substitute for an em dash.
- **Allowed Alternatives:** Use commas, colons, semicolons, parentheses, or separate sentences instead to structure pauses and secondary thoughts.
`
